...
/*
int main() {
    SupabaseClient supabase("https://xyz.supabase.co", "your-public-anon-key");
    
    // 插入数据示例
    std::string jsonData = "{\"temperature\": 25, \"humidity\": 60}";
    supabase.insertData("sensor_data", jsonData);
    
    // 获取数据示例
    std::string data = supabase.fetchData("sensor_data");
